...
public class ExceptionControllerAdvice extends ResponseEntityExceptionHandler{
    ...
    @ExceptionHandler({FreeInterviewDataIntegrityException.class})
    public ResponseEntity handleDataIntegrityViolationException(FreeInterviewDataIntegrityException ex, WebRequest request) {
        final ErrorResponseTemplate errorResponseTemplate = ex.buildErrorResponse(request);
